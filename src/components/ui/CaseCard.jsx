    ...
    >
      ...
      <div className="flex flex-col gap-4 p-6 lg:p-m">
        <div className="flex justify-between items-start gap-4">
          <h3 className="text-h3 font-medium text-text-main leading-tight relative w-fit pb-1 transition-colors duration-200 group-hover:text-btn-primary-hover after:absolute after:left-0 after:bottom-0 after:h-[2px] after:bg-btn-primary-hover after:w-0 group-hover:after:w-full after:transition-all after:duration-200 after:ease-in-out">
            {title}
          </h3>
